  ...
  return (
    <div className="bg-surface-raised border border-surface-border rounded-md px-6 py-4 mb-6">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-3 gap-x-8">
        <div>
          <p className="text-2xs font-semibold uppercase tracking-widest text-text-tertiary mb-0.5">Run ID</p>
        ...
        <div>
          <p className="text-2xs font-semibold uppercase tracking-widest text-text-tertiary mb-0.5">Tool Calls</p>
          <p className="text-xs text-text-primary">
