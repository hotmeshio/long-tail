...
export const FLEET_TOOLS_INPUT_SCHEMA = {
  ...
  'x-lt-help': [
    ...
    '| Tool | When | Does |',
    '|---|---|---|',
    '| reprint-label | The bag label is missing or unreadable | Prints the bag, plate, or spool label again (1–5 copies) |',
    '| change-filament | The spool ran out or the material is wrong | Records the material and spool count now loaded |',
