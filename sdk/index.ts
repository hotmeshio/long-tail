...
export function createClient(options: LTClientOptions = {}) {
  ...
  return {
    ...
    escalations: {
      ...
      getLookups: bindAuth(escalationsApi.getEscalationLookups, auth),
    ...
    knowledge: {
      ...
      getEntryVersion: knowledgeApi.getEntryVersion,
      listEntryVersions: knowledgeApi.listEntryVersions,
